...
module Q3bFSM(clk, reset, x, z);
  ...
  assign _20_[7] = _19_[9] & _21_[2];
  assign _20_[3] = _19_[9] & _21_[1];
  assign _20_[4] = x & _21_[1];
  assign _20_[1] = _19_[9] & _21_[0];
  ...
  assign _09_[0] = _20_[1] | _20_[4];
  assign _22_[1] = _09_[0] | _20_[7];
  assign _10_[0] = _20_[1] | _20_[3];
  ...
  assign _12_[0] = z;
  assign { _19_[14:10], _19_[8:0] } = { 2'h0, x, x, 2'h0, _19_[9], x, 1'h0, x, _19_[9], x, _19_[9], _19_[9] };
  assign { _20_[14:13], _20_[10], _20_[8], _20_[5], _20_[0] } = { 5'h00, _20_[1] };
endmodule
