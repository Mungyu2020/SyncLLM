...
module Q3cFSMLogic(clk, y, x, Y0, z);
  ...
  assign _17_[9] = _16_[9] & _18_[3];
  assign _17_[6] = x & _18_[2];
  assign _17_[3] = _16_[9] & _18_[1];
  assign _17_[1] = _16_[9] & _18_[0];
  assign _03_ = y[0] | y[1];
  ...
  assign _09_[0] = z;
  assign { _16_[14:10], _16_[8:0] } = { 2'h0, x, x, 2'h0, _16_[9], x, 1'h0, x, _16_[9], x, _16_[9], _16_[9] };
  assign { _17_[14:13], _17_[10], _17_[8], _17_[5], _17_[0] } = { 5'h00, _17_[1] };
