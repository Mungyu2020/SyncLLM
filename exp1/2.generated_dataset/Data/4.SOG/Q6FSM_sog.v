...
module Q6FSM(clk, reset, w, z);
  ...
  assign _01_ = ~state[1];
  assign _03_ = ~state[2];
  assign _20_[9] = _19_[5] & _21_[3];
  assign _20_[6] = _19_[5] & _21_[2];
  assign _20_[3] = w & _21_[1];
  assign _20_[5] = _19_[5] & _21_[1];
  ...
  assign _22_[2] = _20_[5] | _20_[6];
  assign _22_[1] = _20_[1] | _20_[3];
  assign _09_[0] = _20_[0] | _20_[3];
  assign _09_[1] = _20_[6] | _20_[9];
  ...
  assign z = _18_ | _17_;
  assign _19_[5] = ~w;
  assign { _19_[11:6], _19_[4:0] } = { 2'h0, _19_[5], _19_[5], 1'h0, _19_[5], w, w, 2'h1, w };
  assign _21_[0] = _20_[1];
  assign { _20_[11:10], _20_[8:7], _20_[4], _20_[2] } = { 2'h0, _20_[6], 1'h0, _20_[3], 1'h0 };
endmodule
